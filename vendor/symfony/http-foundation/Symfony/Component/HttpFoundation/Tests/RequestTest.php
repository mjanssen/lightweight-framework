...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        // http://host:8080/index.html.twig/path/info?query=string
        ...
        $server['REQUEST_URI'] = '/index.html.twig/path/info?query=string';
        $server['SCRIPT_NAME'] = '/index.html.twig';
        ...
        $this->assertEquals('http://host/index.html.twig/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/index.html.twig/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide index.html.twig)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ index.html.twig [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/index.html.twig';
        $server['PHP_SELF'] = '/index.html.twig';
        $server['SCRIPT_FILENAME'] = '/some/where/index.html.twig';
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/index.html.twig/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/index.html.twig/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/index.html.twig/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/index.html.twig', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/index.html.twig';
        $server['ORIG_SCRIPT_NAME'] = '/index.html.twig';
        $request->initialize(array(), array(), array(), array(), array(), $server);
